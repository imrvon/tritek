      ...
      <div>
          <div className='relative h-screen bg-[url(/assets/img/courses/cyber.webp)] bg-no-repeat bg-cover flex justify-center items-center'>
              <div className='flex flex-col gap-10 relative z-10'>
                  <p className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-dm text-center'>Cyber Security</p>
                  <p className='font-medium text-center text-xl sm:text-2xl text-white italic font-ibm w-9/12 mx-auto'>Master ethical hacking, threat detection, and security architecture while earning industry-recognised certifications. </p>
              </div>

      ...
      <div>
          <div className='relative h-screen bg-[url(/assets/img/courses/digital.webp)] bg-no-repeat bg-cover flex justify-center items-center'>
              <div className='flex flex-col gap-10 relative z-10'>
                  <p className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-heading text-center'>Digital Marketing</p>
                  <p className='font-medium text-center text-xl sm:text-2xl text-white italic font-heading w-9/12 mx-auto'>Learn to create campaigns that convert, master data-driven marketing strategies, and build real marketing campaigns for actual businesses</p>
              </div>
          ...
          <div className="flex flex-wrap">
              <div className="w-full lg:w-1/2 p-[5%]">
                  ...
                  <p className="font-paragraph mt-5">Our graduates manage six-figure marketing budgets and command premium salaries. Join them.</p>
              </div>

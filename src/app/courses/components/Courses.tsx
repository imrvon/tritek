    ...
    <div>
        <div className='relative h-screen bg-[url(/assets/img/courses.webp)] bg-no-repeat bg-cover flex justify-center items-center'>
            <div className='flex flex-col gap-10 relative z-10'>
                <p className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-heading text-center'>Courses</p>
                <p className='font-medium text-center text-xl sm:text-2xl text-white italic font-heading w-9/12 mx-auto'>Transform Your Career in Project Management and Business Analysis</p>
            </div>
        ...
        <div className="bg-grey flex flex-wrap">
            ...
            <div className="w-full lg:w-2/3 p-[5%]">
                ...
                <div>
                    <div>
                        <h3 className="font-paragraph text-lg my-4 text-head-primary uppercase">What You’ll Achieve</h3>
                    ...
                    <div>
                        <h3 className="font-heading text-lg my-4 text-head-primary uppercase">What You’ll Learn</h3>
                        <ul className="font-paragraph">
                ...
                <div>
                    <h4 className="font-heading text-lg mt-4 text-head-primary uppercase">Why Choose This Programme?</h4>
                    <p className="font-paragraph mt-[3.5%] text-lg">Our graduates don’t just land jobs, they thrive as leaders in their industries. With hands-on experience and career mentorship, you’ll be ready to command six-figure salaries in record time.</p>
                    <p className="font-paragraph mt-[3.5%] text-lg">Join thousands of successful alumni who’ve redefined their careers with the Elite Tech Training Programme.</p>
                </div>
        ...
        <div className='flex flex-wrap py-[5%]'>
            ...
            <div className='w-full md:w-1/2 lg:w-1/3 py-[5%] md:-ml-[4%] relative z-10'>
                <div className="flex gap-[5%] flex-wrap mb-[15%] flex-col justify-center items-center md:items-start md:justify-normal md:flex-row">
                    ...
                    <div className="font-paragraph w-10/12 sm:w-7/12 md:text-left text-center">

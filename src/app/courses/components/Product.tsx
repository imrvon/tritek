      ...
      <div>
          <div className='relative h-screen bg-[url(/assets/img/courses/product.webp)] bg-no-repeat bg-cover flex justify-center items-center'>
              <div className='flex flex-col gap-10 relative z-10'>
                  <p className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-dm text-center'>Product Management</p>
                  <p className='font-medium text-center text-xl sm:text-2xl text-white italic font-ibm w-9/12 mx-auto'>Learn to identify market opportunities, develop product strategies, and lead cross-functional teams while building a portfolio of real product launches.
                  </p>
              </div>

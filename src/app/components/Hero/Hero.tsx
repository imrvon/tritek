        ...
        <div className="px-[5%] w-full">
            <div className="sm:w-9/12 text-white mt-[25%] md:mt-[20%]">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <Link href='/courses' className="rounded-[50px] border-[1px] font-paragraph py-4 sm:py-5 px-6 sm:px-7 inline-block bg-transparent shadow-[0_0_0_0_#ffffff_inset] duration-300 ease-in-out transition-all hover:text-primary hover:shadow-[0_0_0_4em_#ffffff_inset,0_5px_15px_rgba(0,0,0,0.1)] hover:-translate-y-[3px] w-fit">Enroll Now</Link>
                    <Link href='/contact' className="rounded-[50px] border-[1px] font-paragraph py-4 sm:py-5 px-6 sm:px-7 inline-block bg-transparent shadow-[0_0_0_0_#ffffff_inset] duration-300 ease-in-out transition-all hover:text-primary hover:shadow-[0_0_0_4em_#ffffff_inset,0_5px_15px_rgba(0,0,0,0.1)] hover:-translate-y-[3px] w-fit">Book a Free Consultation</Link>
                </div>
            </div>
            <div className="mt-[10%] font-paragraph flex items-center text-white relative text-xl before:left-0 before:top-1/2 before:w-full before:h-[1px] before:bg-[#cccccc] after:left-0 after:top-1/2 after:w-full after:h-[1px] after:bg-[#cccccc] w-full">
                <span className="mx-[0.5em] flex-[0_0_auto] font-medium font-heading opacity-60 tracking-wider">You&apos;ll be in good company</span>
            </div>

  ...
  return (
    <header className={navbar ? "font-paragraph flex justify-between items-center px-[5%] py-[1.5%] fixed top-0 left-0 w-full z-50 bg-[#000000a6]" : "font-paragraph flex justify-between items-center px-[5%] py-[1.5%] fixed top-0 left-0 w-full z-50"}>
        ...
        <div className="flex items-center gap-[5%] w-8/12">
            ...
            <nav className={`${
                menuOpen
                ? 'flex p-[5%] justify-center items-center lg:items-start lg:justify-start lg:p-0 flex-col lg:flex-row fixed top-0 left-0 w-[80%] min-h-screen lg:min-h-[unset] lg:static lg:gap-5 xl:gap-8 lg:w-5/6 bg-[#191919] lg:bg-transparent -translate-x-0 lg:-translate-x-0 duration-200 ease-in-out transition-transform'
                : 'flex p-[5%] justify-center items-center lg:items-start lg:justify-start lg:p-0 flex-col lg:flex-row fixed top-0 left-0 w-[80%] min-h-screen lg:min-h-[unset] lg:static lg:gap-5 xl:gap-8 lg:w-5/6 bg-[#191919] lg:bg-transparent -translate-x-full lg:-translate-x-0 duration-200 ease-in-out transition-transform'
            } ${textColor}`}>
                ...
                <Link href='/events' className="tracking-wide uppercase lg:capitalize border-b-solid border-b-[1px] border-b-[rgba(255,255,255,.2)] lg:border-b-transparent w-full text-center p-4 lg:p-0 lg:text-left lg:w-auto">Events</Link>
                <Link href='/our-careers' className="tracking-wide uppercase lg:capitalize border-b-solid border-b-[1px] border-b-[rgba(255,255,255,.2)] lg:border-b-transparent w-full text-center p-4 lg:p-0 lg:text-left lg:w-auto">Careers</Link>

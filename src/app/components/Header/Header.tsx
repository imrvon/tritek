  ...
  return (
    <header className={navbar ? "font-paragraph flex justify-between items-center px-[5%] py-[1.5%] fixed top-0 left-0 w-full z-50 bg-[#000000a6]" : "font-paragraph flex justify-between items-center px-[5%] py-[1.5%] fixed top-0 left-0 w-full z-50"}>
        ...
        <div className="flex items-center gap-[5%] w-8/12">
            ...
            <nav className={menuOpen ? "flex p-[5%] justify-center items-center md:items-start md:justify-start md:p-0 flex-col md:flex-row fixed top-0 left-0 w-[80%] min-h-screen md:min-h-[unset] md:static md:gap-5 lg:gap-14 text-white text-[15px] md:w-4/6 lg:w-5/6 bg-[#191919] md:bg-transparent -translate-x-0 md:-translate-x-0 duration-200 ease-in-out transition-transform" : "flex p-[5%] justify-center items-center md:items-start md:justify-start md:p-0 flex-col md:flex-row fixed top-0 left-0 w-[80%] min-h-screen md:min-h-[unset] md:static md:gap-5 lg:gap-14 text-white text-[15px] md:w-4/6 lg:w-5/6 bg-[#191919] md:bg-transparent -translate-x-full md:-translate-x-0 duration-200 ease-in-out transition-transform"}>
                ...
                <Link href='/courses' className="tracking-wide uppercase md:capitalize border-b-solid border-b-[1px] border-b-[rgba(255,255,255,.2)] md:border-b-transparent w-full text-center p-4 md:p-0 md:text-left md:w-auto">Courses</Link>
                ...
                <div className='flex text-white justify-center mt-[5%] md:hidden'>
        ...
        <div className='hidden md:flex text-white justify-end w-5/12'>

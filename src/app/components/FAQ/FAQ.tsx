...
export default function FAQ() {
  ...
  return (
    <div className='px-[3%] py-[7%] faq'>
        <h2 className='text-center text-4xl sm:text-5xl font-bold font-dm text-head-primary'>Got Questions? Discover Answers Here</h2>
        <div className='flex flex-wrap justify-between mt-[5%]'>
            {
                faqData.map((data)=> (
                    <div className='tritek_faq w-full lg:w-[49%] mb-[2%] font-nuno' key={data.id}>

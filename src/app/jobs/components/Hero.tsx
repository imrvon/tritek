...
export default function Hero() {
  return (
    <div className="relative h-[30rem] lg:h-screen flex bg-cover bg-center bg-no-repeat bg-[url('https://www.posturite.co.uk/media/wysiwyg/young-people_office-workers.jpg')] text-white items-center font-ibm">
       <div className="absolute inset-0 bg-black opacity-50 z-0"></div>
      <div className="px-[5%] relative z-10 flex flex-col items-center gap-10 justify-center w-full">
        <h2 className="text-6xl md:text-7xl lg:text-8xl font-bold text-center">Tritek Jobs</h2>

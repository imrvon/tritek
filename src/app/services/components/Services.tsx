    ...
    <section>
      ...
      <div className="bg-[#f7f7f5] flex flex-wrap">
          <article className="lg:w-1/2 p-[5%]">
            <h2 className="font-spartan text-lg tracking-wider font-medium text-secondary mb-[5%]">INTRODUCTION</h2>
            <h3 className="font-dm text-3xl sm:text-4xl md:text-5xl text-head-primary">Helping You Solve Workforce Challenges</h3>
            <p className="font-nuno mt-[3.5%] text-lg">Organisations today face a rapidly shifting landscape: skills gaps, evolving technologies, and the need for agile, innovative teams. Whether you’re a corporate entity or a public-sector organisation, Tritek Academy provides targeted solutions to equip your teams with the knowledge, tools, and confidence they need to thrive.</p>
          </article>
      ...
      <div className="bg-grey flex flex-col-reverse lg:flex-row flex-wrap">
            <div className="w-full lg:w-2/3 p-[5%]">
                ...
                <div>
                    <div>
                        <h3 className="font-spartan text-lg my-4 text-head-primary uppercase">Our Approach</h3>
                        <ul className="font-nuno">

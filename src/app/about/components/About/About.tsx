        ...
        <section>
            ...
            <div className='flex flex-wrap flex-col md:flex-row'>
                <div className="p-[5%] md:w-1/2">
                    <h3 className="font-heading text-3xl sm:text-4xl md::text-5xl w-5/6 text-head-primary">Welcome to Tritek Academy</h3>
                    <p className="font-paragraph mt-[2.5%] text-lg">At Tritek Academy, we believe technology is not just a tool; it’s a gateway to transformation. In a world where traditional career paths are constantly disrupted, we stand at the crossroads of change, empowering individuals to harness technology and redefine their futures.</p>
                    
                    <h2 className="font-heading text-lg tracking-wider font-semibold text-secondary mt-[3%]">OUR MISSION</h2>
                    <p className="font-paragraph mt-[1.5%] text-lg">To go beyond traditional technical education by crafting learning journeys that transform lives. We nurture the human potential behind the code, the strategy behind the systems, and the purpose behind the projects.</p>
                    <p className="font-paragraph mt-[3.5%] text-lg">Through immersive, project-based experiences in Business Analysis, Cybersecurity, Data Analysis, Digital Marketing, Product Management, Project Management, and emerging technologies, we prepare professionals to tackle real-world challenges and make meaningful contributions to their industries.</p>

                    <h2 className="font-heading text-lg tracking-wider font-semibold text-secondary mt-[3%] uppercase">Our Vision</h2>
                    <p className="font-paragraph mt-[1.5%] text-lg">We envision a future where technology education knows no boundaries. Tritek Academy is the cornerstone of global digital career transformation, enabling every individual, regardless of their background, to harness the power of technology for impactful innovation.</p>
                    <p className="font-paragraph mt-[3.5%] text-lg">Our graduates don’t just earn certificates – they become architects of digital transformation, leveraging their skills to revolutionize industries, solve complex problems, and lead with confidence.</p>
                </div>
            ...
            <div className="flex flex-wrap flex-col-reverse md:flex-row">
                ...
                <div className='md:w-1/2 p-[5%]'>
                    <h3 className="font-heading text-3xl sm:text-4xl md:text-5xl w-5/6 text-head-primary">What Sets Us Apart</h3>
                        ...
                        <h3 className="font-paragraph text-lg my-4 text-head-primary uppercase">Our Values</h3>
                        <div>
                            <ul className='mt-[5%]'>
                    ...
                    <p className="font-paragraph mt-[3.5%] text-lg">Join Tritek Academy and take the first step toward a career transformation that not only prepares you for the future but empowers you to shape it.</p>
                </div>  
            </div>
            ...
            <div className="flex flex-wrap flex-col md:flex-row">
                <div className='md:w-1/2 p-[5%]'>
                    ...
                    <p className="font-paragraph mt-[3.5%] text-lg">Her impact goes beyond business success. Dr. Cole has spearheaded initiatives to foster diversity and inclusion, with Tritek Academy being recognised as one of the Top 20 Black Businesses in the UK by Channel 4 in partnership with Lloyds Bank.</p>
                    <p className="font-paragraph mt-[3.5%] text-lg">Dr. Cole’s philanthropic efforts include sponsoring over 100 individuals to access life-changing tech opportunities. She mentors young women weekly at Oasis Academy, providing them with the tools to dream big and achieve more.</p>
                    <p className="font-paragraph mt-[3.5%] text-lg">Dr. Cole lives by the mantra: “Make a way, not an excuse.” Her authenticity, integrity, and resilience inspire learners and professionals alike to break barriers and unlock their potential.</p>
                    <h4 className='mt-[5%] font-semibold text-head-primary text-2xl font-paragraph'>A Legacy of Empowerment
                    </h4>
                    <p className="font-paragraph mt-[3.5%] text-lg">Through Tritek Academy and her personal initiatives, Dr. Adeshola Cole continues to shape the future of tech education, leaving an indelible mark on the global workforce.</p>
                </div>
